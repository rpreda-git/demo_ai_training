-- Demo seed for kanban-db (organizations, priority, activity, checklists).
-- Apply to a FRESH remote D1:  npx wrangler d1 execute kanban-db --remote --file=drizzle/seed-demo.sql
-- Logins: demo@kanban.dev / demo1234   and   grace@kanban.dev / grace1234

INSERT OR IGNORE INTO "user" ("id", "name", "email", "email_verified", "image", "created_at", "updated_at", "active_organization_id", "two_factor_enabled") VALUES ('LxAmh2eluag28qi4dy2UA9nbwXRuHOWl', 'Ada Lovelace', 'demo@kanban.dev', 0, NULL, 1782239932, 1782287160, NULL, 0);
INSERT OR IGNORE INTO "user" ("id", "name", "email", "email_verified", "image", "created_at", "updated_at", "active_organization_id", "two_factor_enabled") VALUES ('Bd6Ai9UWjEuR240kIuncQgeRg2ErcRea', 'Grace Hopper', 'grace@kanban.dev', 0, NULL, 1782239933, 1782239933, NULL, 0);
...
INSERT OR IGNORE INTO "organization" ("id", "name", "owner_id", "created_at") VALUES ('542824cff029b6d32c7e1e2beeff7beb', 'Ada Lovelace''s Workspace', 'LxAmh2eluag28qi4dy2UA9nbwXRuHOWl', 1782286728);
INSERT OR IGNORE INTO "organization" ("id", "name", "owner_id", "created_at") VALUES ('60125218e02ad98f8b88c2f4243c15aa', 'Grace Hopper''s Workspace', 'Bd6Ai9UWjEuR240kIuncQgeRg2ErcRea', 1782286728);

INSERT OR IGNORE INTO "org_member" ("organization_id", "user_id", "role", "created_at") VALUES ('542824cff029b6d32c7e1e2beeff7beb', 'LxAmh2eluag28qi4dy2UA9nbwXRuHOWl', 'owner', 1782286728);
INSERT OR IGNORE INTO "org_member" ("organization_id", "user_id", "role", "created_at") VALUES ('60125218e02ad98f8b88c2f4243c15aa', 'Bd6Ai9UWjEuR240kIuncQgeRg2ErcRea', 'owner', 1782286728);
INSERT OR IGNORE INTO "org_member" ("organization_id", "user_id", "role", "created_at") VALUES ('542824cff029b6d32c7e1e2beeff7beb', 'Bd6Ai9UWjEuR240kIuncQgeRg2ErcRea', 'member', 1782286728);

INSERT OR IGNORE INTO "board" ("id", "owner_id", "title", "description", "color", "created_at", "updated_at", "organization_id") VALUES ('4f02dae0-c169-4ac0-895a-a256b7525ef5', 'LxAmh2eluag28qi4dy2UA9nbwXRuHOWl', 'Product Roadmap', 'Q3 planning for the web platform.', '#6366f1', 1782239932, 1782239932, '542824cff029b6d32c7e1e2beeff7beb');
INSERT OR IGNORE INTO "board" ("id", "owner_id", "title", "description", "color", "created_at", "updated_at", "organization_id") VALUES ('055c0470-8572-4672-bed2-91c014b61b04', 'LxAmh2eluag28qi4dy2UA9nbwXRuHOWl', 'Personal Tasks', 'Day-to-day todos.', '#10b981', 1782239933, 1782239933, '542824cff029b6d32c7e1e2beeff7beb');
...
INSERT OR IGNORE INTO "card" ("id", "column_id", "board_id", "title", "description", "position", "due_date", "completed", "created_at", "updated_at", "assignee_id", "priority") VALUES ('ee8431e0-2905-4ba4-90b4-aa0a9f65f46d', 'a7127ce9-d9c8-4533-b7cb-5146dbc182c8', '4f02dae0-c169-4ac0-895a-a256b7525ef5', 'Design the new onboarding flow', 'Reduce drop-off on the first run experience.', 1000, 1782671932, 1, 1782239932, 1782239976, 'Bd6Ai9UWjEuR240kIuncQgeRg2ErcRea', 'none');
INSERT OR IGNORE INTO "card" ("id", "column_id", "board_id", "title", "description", "position", "due_date", "completed", "created_at", "updated_at", "assignee_id", "priority") VALUES ('6cefb32e-c727-4922-bab2-026e354f78b3', 'a7127ce9-d9c8-4533-b7cb-5146dbc182c8', '4f02dae0-c169-4ac0-895a-a256b7525ef5', 'Investigate slow dashboard query', NULL, 2000, 1782326332, 0, 1782239932, 1782239932, NULL, 'none');
INSERT OR IGNORE INTO "card" ("id", "column_id", "board_id", "title", "description", "position", "due_date", "completed", "created_at", "updated_at", "assignee_id", "priority") VALUES ('faf1f77b-9e5a-4ec5-9412-a1b0eb317aa0', '1dd205fc-a5d6-42a1-921c-59db723a5963', '4f02dae0-c169-4ac0-895a-a256b7525ef5', 'Build the Kanban drag-and-drop', 'Cards should move between columns optimistically.', 1000, NULL, 0, 1782239932, 1782239932, NULL, 'none');
INSERT OR IGNORE INTO "card" ("id", "column_id", "board_id", "title", "description", "position", "due_date", "completed", "created_at", "updated_at", "assignee_id", "priority") VALUES ('627eca34-1fc1-4976-bdc8-e0688ab5efbf', '1dd205fc-a5d6-42a1-921c-59db723a5963', '4f02dae0-c169-4ac0-895a-a256b7525ef5', 'Wire up Better Auth sessions', NULL, 2000, NULL, 0, 1782239932, 1782239932, NULL, 'none');
INSERT OR IGNORE INTO "card" ("id", "column_id", "board_id", "title", "description", "position", "due_date", "completed", "created_at", "updated_at", "assignee_id", "priority") VALUES ('d04e77c9-c9d5-4853-8f0d-bb89b9c3eb29', 'c012509d-75a5-421c-9f74-5f0862f5ac4c', '4f02dae0-c169-4ac0-895a-a256b7525ef5', 'Set up Cloudflare Workers + D1', NULL, 1000, NULL, 1, 1782239932, 1782239932, NULL, 'none');
INSERT OR IGNORE INTO "card" ("id", "column_id", "board_id", "title", "description", "position", "due_date", "completed", "created_at", "updated_at", "assignee_id", "priority") VALUES ('0fe8fcba-1d37-4da1-b32a-02604d36f273', 'c012509d-75a5-421c-9f74-5f0862f5ac4c', '4f02dae0-c169-4ac0-895a-a256b7525ef5', 'Scaffold the project', NULL, 2000, NULL, 1, 1782239933, 1782239933, NULL, 'none');
INSERT OR IGNORE INTO "card" ("id", "column_id", "board_id", "title", "description", "position", "due_date", "completed", "created_at", "updated_at", "assignee_id", "priority") VALUES ('e19192a8-0ec0-4a3d-a799-74431b23afd2', 'a1754026-6445-42a2-9915-1f5cde5ee145', '055c0470-8572-4672-bed2-91c014b61b04', 'Buy groceries', NULL, 1000, 1782239933, 0, 1782239933, 1782287886, NULL, 'high');
INSERT OR IGNORE INTO "card" ("id", "column_id", "board_id", "title", "description", "position", "due_date", "completed", "created_at", "updated_at", "assignee_id", "priority") VALUES ('4fc2969c-da4e-4045-8c8f-1e2838dc0a6d', 'a1754026-6445-42a2-9915-1f5cde5ee145', '055c0470-8572-4672-bed2-91c014b61b04', 'Read ''Designing Data-Intensive Applications''', NULL, 2000, NULL, 0, 1782239933, 1782239933, NULL, 'none');
INSERT OR IGNORE INTO "card" ("id", "column_id", "board_id", "title", "description", "position", "due_date", "completed", "created_at", "updated_at", "assignee_id", "priority") VALUES ('560bda35-de2a-4544-ae11-d0be5d89a5b6', 'cc0854ed-d311-43f6-8d7b-40c084278505', '055c0470-8572-4672-bed2-91c014b61b04', 'Plan weekend trip', NULL, 1000, 1782499133, 0, 1782239933, 1782239933, NULL, 'none');
INSERT OR IGNORE INTO "card" ("id", "column_id", "board_id", "title", "description", "position", "due_date", "completed", "created_at", "updated_at", "assignee_id", "priority") VALUES ('811c7e51-3b25-497e-af4f-5cbe1106dd87', '73c8057a-bb8f-4965-8606-4571ebbf1429', '055c0470-8572-4672-bed2-91c014b61b04', 'Renew gym membership', NULL, 1000, NULL, 1, 1782239933, 1782239933, NULL, 'none');
...
INSERT OR IGNORE INTO "comment" ("id", "card_id", "user_id", "body", "created_at") VALUES ('40f501ba-36a0-43af-b066-9309e28f291a', 'e19192a8-0ec0-4a3d-a799-74431b23afd2', 'LxAmh2eluag28qi4dy2UA9nbwXRuHOWl', 'Activity test comment', 1782287886);
...
INSERT OR IGNORE INTO "activity" ("id", "board_id", "user_id", "type", "data", "created_at") VALUES ('6dcda56b-9f48-411b-ad1b-d8d12ad8e135', '055c0470-8572-4672-bed2-91c014b61b04', 'LxAmh2eluag28qi4dy2UA9nbwXRuHOWl', 'comment.added', '{"cardTitle":"Buy groceries"}', 1782287886);

-- Set each user’s active organization (after orgs exist).
UPDATE "user" SET "active_organization_id"='542824cff029b6d32c7e1e2beeff7beb' WHERE "id"='LxAmh2eluag28qi4dy2UA9nbwXRuHOWl';
UPDATE "user" SET "active_organization_id"='60125218e02ad98f8b88c2f4243c15aa' WHERE "id"='Bd6Ai9UWjEuR240kIuncQgeRg2ErcRea';
